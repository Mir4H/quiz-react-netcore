    ...
    >
      <Box sx={{ display: "flex", flexDirection: "column", flexGrow: 1 }}>
        <CardContent sx={{ flex: "1 0 auto", textAlign: "center" }}>
          ...
          <Button variant="contained" sx={{mx: 1}} size="small" onClick={submitScore}>Save Score</Button>
          <Button variant="contained" sx={{mx: 1}} size="small" onClick={restart}>Try Again</Button>
          <Alert severity="success" variant="string" sx={{width: '60%', m: 'auto', visibility: showAlert ? 'visible' : 'hidden'}}>Score Updated.</Alert>
        </CardContent>
      </Box>
      <CardMedia
        component="img"
